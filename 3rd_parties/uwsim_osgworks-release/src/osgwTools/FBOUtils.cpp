...
GLvoid glGenFramebuffers( FBOExtensions* fboExt, GLsizei n, GLuint* framebuffer )
{
...
GLvoid glDeleteFramebuffers( FBOExtensions* fboExt, GLsizei n, GLuint* framebuffer )
{
#if( OSGWORKS_OSG_VERSION >= OSG_FBO_CHANGE_VERSION )
...
GLvoid glBindFramebuffer( FBOExtensions* fboExt, GLenum target, GLuint framebuffer )
{
#if( OSGWORKS_OSG_VERSION >= OSG_FBO_CHANGE_VERSION )
...
GLvoid glFramebufferTexture2D( FBOExtensions* fboExt, GLenum target, GLenum attachment,
...
GLvoid glBlitFramebuffer( FBOExtensions* fboExt, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1,
