...
using FBOExtensions = osg::GLExtensions;

GLvoid OSGWTOOLS_EXPORT glGenFramebuffers( FBOExtensions* fboExt, GLsizei n, GLuint* framebuffer );
GLvoid OSGWTOOLS_EXPORT glDeleteFramebuffers( FBOExtensions* fboExt, GLsizei n, GLuint* framebuffer );
GLvoid OSGWTOOLS_EXPORT glBindFramebuffer( FBOExtensions* fboExt, GLenum target, GLuint framebuffer );

GLvoid OSGWTOOLS_EXPORT glFramebufferTexture2D( FBOExtensions* fboExt, GLenum target, GLenum attachment,
            GLenum textarget, GLuint texture, GLint level );
GLvoid OSGWTOOLS_EXPORT glBlitFramebuffer(  FBOExtensions* fboExt, GLint srcX0, GLint srcY0, GLint srcX1,
